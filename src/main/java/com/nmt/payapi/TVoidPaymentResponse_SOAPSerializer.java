...
public class TVoidPaymentResponse_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public TVoidPaymentResponse_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nmt.payapi.TVoidPaymentResponse instance = new com.nmt.payapi.TVoidPaymentResponse();
        com.nmt.payapi.TVoidPaymentResponse_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_MessageCode_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nmt.payapi.TVoidPaymentResponse_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nmt.payapi.TVoidPaymentResponse instance = (com.nmt.payapi.TVoidPaymentResponse)obj;
