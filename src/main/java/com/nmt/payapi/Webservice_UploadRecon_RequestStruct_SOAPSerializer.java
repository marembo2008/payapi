...
public class Webservice_UploadRecon_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_TransactionAmount_QNAME = new QName("", "TransactionAmount");
    ...
    public Webservice_UploadRecon_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nmt.payapi.Webservice_UploadRecon_RequestStruct instance = new com.nmt.payapi.Webservice_UploadRecon_RequestStruct();
        com.nmt.payapi.Webservice_UploadRecon_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<7; i++) {
            ...
            if (elementName.equals(ns1_LoginID_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nmt.payapi.Webservice_UploadRecon_RequestStruct_SOAPBuilder();
                    }
            ...
            if (elementName.equals(ns1_TransactionAmount_QNAME)) {
                member = ns2_myns2__double__double_Double_Serializer.deserialize(ns1_TransactionAmount_QNAME, reader, context);
                instance.setTransactionAmount(((Double)member).doubleValue());
                reader.nextElementContent();
                continue;
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nmt.payapi.Webservice_UploadRecon_RequestStruct instance = (com.nmt.payapi.Webservice_UploadRecon_RequestStruct)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns2_myns2__double__double_Double_Serializer.serialize(new Double(instance.getTransactionAmount()), ns1_TransactionAmount_QNAME, null, writer, context);
