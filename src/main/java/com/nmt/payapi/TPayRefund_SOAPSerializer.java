...
public class TPayRefund_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public TPayRefund_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nmt.payapi.TPayRefund instance = new com.nmt.payapi.TPayRefund();
        com.nmt.payapi.TPayRefund_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_MessageCode_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nmt.payapi.TPayRefund_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nmt.payapi.TPayRefund instance = (com.nmt.payapi.TPayRefund)obj;
