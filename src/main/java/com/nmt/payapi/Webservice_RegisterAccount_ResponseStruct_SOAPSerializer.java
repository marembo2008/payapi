...
public class Webservice_RegisterAccount_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Webservice_RegisterAccount_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nmt.payapi.Webservice_RegisterAccount_ResponseStruct instance = new com.nmt.payapi.Webservice_RegisterAccount_ResponseStruct();
        com.nmt.payapi.Webservice_RegisterAccount_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nmt.payapi.Webservice_RegisterAccount_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nmt.payapi.Webservice_RegisterAccount_ResponseStruct instance = (com.nmt.payapi.Webservice_RegisterAccount_ResponseStruct)obj;
