...
public class TEchoResult_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public TEchoResult_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nmt.payapi.TEchoResult instance = new com.nmt.payapi.TEchoResult();
        com.nmt.payapi.TEchoResult_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_MessageCode_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nmt.payapi.TEchoResult_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nmt.payapi.TEchoResult instance = (com.nmt.payapi.TEchoResult)obj;
